...
<xsl:stylesheet 
    ...
    <xsl:template match="/">
                ...
                <main class="flex-shrink-0 flex-grow-1">
                    ...
                    <div class="container">
                        ...
                        <div class="text-center p-1">
                            <span id="counter1"/> von <span id="counter2"/>Titel
                        </div>
                        ...
                        <table id="myTable">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" tabulator-headerFilter="input" tabulator-maxWidth="170">Nennungen</th>
                                    <th scope="col" tabulator-headerFilter="input"
                            ...
                            <tbody>
                                <xsl:for-each select=".//tei:bibl[@xml:id]">
                                    <xsl:sort select="normalize-space(./tei:title/text())"/>
                                    ...
                                    <tr>
                                        <td>
                                            <a>
                                                ...
                                                <xsl:value-of select="normalize-space(./tei:title/text())"/>
                                            </a>
                                        </td>
                                        <td>
        ...
        <xsl:for-each select=".//tei:bibl[@xml:id]">
            ...
            <xsl:variable name="doc_title" select="normalize-space(string-join(./tei:title[1]//text()))"></xsl:variable>
